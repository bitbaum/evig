  ...
  try {
    ...
    if (
      ...
      return apiBadRequest(
        'Benutzer aus der Kern-Super-Admin-Liste können nicht herabgestuft werden',
      );
    }
    ...
    if (newSuperAdminStatus !== undefined) {
      await logSuperAdminChange(auditContext, targetUser.id, targetUser.email, newSuperAdminStatus);
