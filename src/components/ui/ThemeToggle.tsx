...
export function ThemeToggle({ className }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex h-11 w-11 items-center justify-center rounded-lg border border-subtle bg-surface-raised text-text-tertiary transition-colors hover:border-strong hover:text-text-primary',
        className,
      )}
    >
