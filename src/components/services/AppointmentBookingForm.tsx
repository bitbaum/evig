  ...
  return (
    ...
    >
      <div className="max-h-[70vh] overflow-y-auto">
        ...
        {submitResult && (
          <div
            id={submitResult.success ? undefined : 'appointment-error'}
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            <div>
              ...
              <Textarea
                ...
                aria-describedby={
                  submitResult && !submitResult.success ? 'appointment-error' : undefined
                }
              />
            </div>
            ...
            <div>
              ...
              <Select
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    urgency: e.target.value as 'normal' | 'high' | 'urgent',
                  }))
                }
              >
